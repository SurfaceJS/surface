...
export default class PalleteSpec
{
    ...
    public generatePalleteWithoutRange(): void
    {
        ...
        [
            { index: 1, color: { h: 0, s: 1, v: 1,    a: 1 }},
            { index: 2, color: { h: 0, s: 1, v: 0.75, a: 1 }},
            { index: 3, color: { h: 0, s: 1, v: 0.5,  a: 1 }},
            { index: 4, color: { h: 0, s: 1, v: 0.25, a: 1 }},
            { index: 5, color: { h: 0, s: 1, v: 0,    a: 1 }},
        ];
    ...
    public generatePalleteWithRangeAndSwatchAtStart(): void
    {
        ...
        [
            { index: 1, color: { h: 0, s: 1, v: 1,                   a: 1 }},
            { index: 2, color: { h: 0, s: 1, v: 0.8,                 a: 1 }},
            { index: 3, color: { h: 0, s: 1, v: 0.6,                 a: 1 }},
            { index: 4, color: { h: 0, s: 1, v: 0.3999999999999999,  a: 1 }},
            { index: 5, color: { h: 0, s: 1, v: 0.19999999999999996, a: 1 }},
        ];
    ...
    public generatePalleteWithRangeAndSwatchAtEnd(): void
    {
        ...
        const expected: Array<Swatch> =
        [
            { index: 1, color: { h: 0, s: 0.2,                v: 1, a: 1 }},
            { index: 2, color: { h: 0, s: 0.4,                v: 1, a: 1 }},
            { index: 3, color: { h: 0, s: 0.6000000000000001, v: 1, a: 1 }},
            { index: 4, color: { h: 0, s: 0.8,                v: 1, a: 1 }},
            { index: 5, color: { h: 0, s: 1,                  v: 1, a: 1 }},
        ];
    ...
    public generatePalleteWithRangeAndSwatchRandom(): void
    {
        ...
        [
            ...
            { index: 9,  color: { h: 0.1,                 s: 0.5,                 v: 0.5,                 a: 1 }},
            { index: 10, color: { h: 0.06666666666666668, s: 0.6666666666666666,  v: 0.6666666666666666,  a: 1 }},
            { index: 11, color: { h: 0.03333333333333334, s: 0.8333333333333333,  v: 0.8333333333333333,  a: 1 }},
            { index: 12, color: { h: 0,                   s: 1,                   v: 1,                   a: 1 }},
            { index: 13, color: { h: 0.16666666666666666, s: 0.9,                 v: 0.7333333333333334,  a: 1 }},
            { index: 14, color: { h: 0.3333333333333333,  s: 0.7999999999999999,  v: 0.4666666666666667,  a: 1 }},
            { index: 15, color: { h: 0.5,                 s: 0.7,                 v: 0.2,                 a: 1 }},
