...
export const validExpectations: Array<ParserValidExpectation> =
[
    {
        pattern: "/path",
        expected:
...
export const invalidExpectations: Array<ParserInvalidExpectation> =
[
    { pattern: "",                      error: new Error("Unexpected end of path") },
    { pattern: "path",                  error: new Error("Unexpected token path at 0") },
    { pattern: "/path{}",               error: new Error("Unexpected token } at 6") },
    { pattern: "/path{{}",              error: new Error("Unexpected token { at 6") },
    { pattern: "/path:",                error: new Error("Unexpected token : at 5") },
    { pattern: "/path{value}{another}", error: new Error("Unexpected token { at 12") },
    { pattern: "/path{**rest}",         error: new Error("Unexpected token * at 7") },
    { pattern: "/ ",                    error: new Error("Unexpected space at 1") },
];