...
function setup(type: "ok" | "ko"): void
{
    ...
    const statsMock            = Mock.intance<webpack.Stats>();
    const compilerWatchingMock = Mock.intance<webpack.Compiler.Watching>();
    ...
    const compilerMock = Mock.intance<webpack.Compiler>();
    ...
    const WebpackDevServerMock = Mock.intance<WebpackDevServer>();
