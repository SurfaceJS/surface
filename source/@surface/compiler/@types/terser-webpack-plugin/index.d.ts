...
declare module "terser-webpack-plugin"
{
    ...
    {
        constructor(options?: TerserWebpackPlugin.Options)
    }
    ...
    export namespace TerserWebpackPlugin
    {
        export interface Compress
        {
            ...
            /** Pass true to prevent the compressor from discarding function names. Pass a regular expression to only keep class names matching that regex. Useful for code relying on Function.prototype.name. See also: the keep_fnames mangle option. */
            keep_fnames?: boolean,
            ...
            top_retain?: null|string|Array<string>|RegExp|Function,
        ...
        export interface ExtractComments
        {
        ...
        export interface Mangle
        {
            ...
            /** Prevent mangle function names. Pass a regular expression to only keep class names matching that regex. Useful for code relying on Function.prototype.name. See also: the keep_fnames compress option. */
            keep_fnames?: boolean,
