export default class Messages
{
    ...
    public static readonly invalidEscapedReservedWord    = "Keyword must not contain escaped characters";
    public static readonly invalidHexEscapeSequence      = "Invalid hexadecimal escape sequence";
    ...
    public static readonly templateOctalLiteral          = "Octal literals are not allowed in template strings.";
