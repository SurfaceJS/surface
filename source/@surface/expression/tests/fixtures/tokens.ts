...
[
    ...
    { token: "`\\1`",                       message: Messages.templateOctalLiteral },
    { token: "`\\01`",                      message: Messages.templateOctalLiteral },
    { token: "\\u{006E}\\u{0065}\\u{0077}", message: Messages.invalidEscapedReservedWord },
    { token: "'\\xh'",                      message: Messages.invalidHexEscapeSequence },
    { token: "`\\xh`",                      message: Messages.invalidHexEscapeSequence },
    { token: "1_.123",                      message: Messages.numericSepatorNotAllowed },
    { token: "1._123",                      message: Messages.numericSepatorNotAllowed },
    { token: "1.123_",                      message: Messages.numericSepatorNotAllowed },
    { token: "0x_12",                       message: Messages.numericSepatorNotAllowed },
    { token: "0x12_",                       message: Messages.numericSepatorNotAllowed },
    { token: "0b_10",                       message: Messages.numericSepatorNotAllowed },
    { token: "0b10_",                       message: Messages.numericSepatorNotAllowed },
    { token: "0o_10",                       message: Messages.numericSepatorNotAllowed },
    { token: "0O_10",                       message: Messages.numericSepatorNotAllowed },
    { token: "0o10_",                       message: Messages.numericSepatorNotAllowed },
    { token: "0O10_",                       message: Messages.numericSepatorNotAllowed },
    { token: "010_",                        message: Messages.numericSepatorNotAllowed },
];