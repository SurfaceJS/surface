...
import Depsync, { IOptions, StrategyType }     from "../internal/depsync";
import NpmRepository                           from "../internal/npm-repository";

const toLookup = (source: Array<IPackage>) => new Map(source.map(x => [x.name, x]));
...
export default class PublisherSpec
{
    ...
    {
        const actual: Array<IPackage> =
        [
            { name: "a", version: "2.0.0", dependencies:    { b: "0.0.0" } },
            { name: "b", version: "1.5.0", devDependencies: { c: "0.0.0" } },
            { name: "c", version: "1.0.0-alpha.0" }
        ];

        const expected: Array<IPackage> =
        [
            { name: "a", version: "2.0.0", dependencies:    { b: "1.5.0" } },
            { name: "b", version: "1.5.0", devDependencies: { c: "1.0.0-alpha.0" } },
            { name: "c", version: "1.0.0-alpha.0" }
        ];
        ...
        npmRepositoryMock.setup("get").call(It.any(), It.any()).returns(Promise.resolve(getDataMock.proxy));
    ...
    public async strategyTypeDefaultWithPackages(): Promise<void>
    {
        const actual: Array<IPackage> =
        [
            { name: "a", version: "2.0.0", dependencies:    { b: "0.0.0", c: "0.0.0" } },
            { name: "b", version: "1.5.0", devDependencies: { c: "0.0.0" } },
            { name: "c", version: "1.0.0-alpha.0" }
        ];
        ...
        const expected: Array<IPackage> =
        [
            { name: "a", version: "2.0.1", dependencies:    { b: "1.5.1", c: "1.0.0-alpha.0" } },
            { name: "b", version: "1.5.1", devDependencies: { c: "1.0.0-alpha.0" } },
            { name: "c", version: "1.0.0-alpha.0" }
        ];
        ...
        const npmRepositoryMock = new Mock(NpmRepository);
        npmRepositoryMock.setup("get").call("a", It.any()).returns(Promise.resolve(aGetDataMock.proxy));
        npmRepositoryMock.setup("get").call("b", It.any()).returns(Promise.resolve(bGetDataMock.proxy));
        npmRepositoryMock.setup("get").call("c", It.includes({ timeout: 3 }, { timeout: 2 }, { })).returns(Promise.reject({ code: "E404" }));
    ...
    public async strategyTypeDefaultWithVersion(): Promise<void>
    {
        ...
        const expected: Array<IPackage> =
        [
            { name: "a", version: "2.2.0", dependencies:    { b: "1.5.1" } },
            { name: "b", version: "1.5.1", devDependencies: { c: "1.2.0" } },
        ...
        const npmRepositoryMock = new Mock(NpmRepository);
        npmRepositoryMock.setup("get").call("b", It.any()).returns(Promise.resolve(bGetDataMock.proxy));
        npmRepositoryMock.setup("get").call(It.any(), It.any()).returns(Promise.reject({ code: "E404" }));
    ...
    public async strategyTypeDefaultWithVersionPrerelease(): Promise<void>
    {
        const actual: Array<IPackage> =
        [
            { name: "a", version: "2.0.0",         devDependencies: { b: "1.5.0" } },
            { name: "b", version: "1.5.0",         devDependencies: { c: "1.0.0-alpha.0" } },
            { name: "c", version: "1.3.0-alpha.0", devDependencies: { d: "1.0.0" } },
            { name: "d", version: "1.0.0" }
        ];

        const expected: Array<IPackage> =
        [
            { name: "a", version: "2.2.0",         devDependencies: { b: "1.5.1" } },
            { name: "b", version: "1.5.1",         devDependencies: { c: "1.3.0-alpha.1" } },
            { name: "c", version: "1.3.0-alpha.1", devDependencies: { d: "1.2.0" } },
        ...
        const npmRepositoryMock = new Mock(NpmRepository);
        npmRepositoryMock.setup("get").call("b", It.any()).returns(Promise.resolve(bGetDataMock.proxy));
        npmRepositoryMock.setup("get").call("c", It.any()).returns(Promise.resolve(cGetDataMock.proxy));
        npmRepositoryMock.setup("get").call(It.any(), It.any()).returns(Promise.reject({ code: "E404" }));
    ...
    public async strategyTypeDefaultWithForceUpdate(): Promise<void>
    {
        ...
        const expected: Array<IPackage> =
        [
            { name: "a", version: "2.0.0", dependencies: { b: "2.0.0" } },
            { name: "b", version: "2.0.0" },
        ];
    ...
    public async strategyTypeDefaultWithIgnoreDependents(): Promise<void>
    {
        ...
        [
            { name: "a", version: "2.0.0",         dependencies:    { b: "1.5.0" } },
            { name: "b", version: "1.5.0",         devDependencies: { c: "1.0.0-alpha.0" } },
            { name: "c", version: "1.3.0-alpha.0", dependencies:    { e: "1.0.0" } },
            { name: "e", version: "1.0.0" }
        ];

        const expected: Array<IPackage> =
        [
            { name: "a", version: "2.2.0",         dependencies:    { b: "1.5.0" } },
            { name: "b", version: "1.5.0",         devDependencies: { c: "1.0.0-alpha.0" } },
            { name: "c", version: "1.3.0-alpha.0", dependencies:    { e: "1.0.0" } },
    ...
    public async strategyTypeOnlyStableWithVersionPrerelease(): Promise<void>
    {
        const actual: Array<IPackage> =
        [
            { name: "a", version: "3.0.0", dependencies:    { b: "3.0.0" } },
            { name: "b", version: "3.0.0", devDependencies: { c: "1.0.0-alpha.0" } },
            { name: "c", version: "1.0.0-alpha.0" }
        ];
    ...
    public async strategyTypeDefaultWithIgnoreDependentsAndOnlyStable(): Promise<void>
    {
        ...
        const expected: Array<IPackage> =
        [
            { name: "a", version: "3.0.0",         dependencies:    { b: "1.5.0" } },
            { name: "b", version: "3.0.0",         devDependencies: { c: "1.0.0-alpha.0" } },
            { name: "c", version: "1.3.0-alpha.0", dependencies:    { e: "1.0.0" } },
    ...
    public async repositoryError(): Promise<void>
    {
        ...
        const npmRepositoryMock = new Mock(NpmRepository);
        npmRepositoryMock.setup("get").call(It.any(), It.any()).returns(Promise.reject(expected));
