...
declare module "npm-registry-client"
{
    ...
    export interface IConfiguration
    {
        ...
        maxSockets?: number;
        /** Identify to severs if this request is coming from CI (for statistics purposes). Default = detected from environment– primarily this is done by looking for the CI environment variable to be set to true. Also accepted are the existence of the JENKINS_URL, bamboo.buildKey and TDDIUM environment variables. */ 
        isFromCI?: boolean;
    ...
    export interface IRequestParams
    {
        ...
        body: unknown; //{Stream | Buffer | String | Object}
