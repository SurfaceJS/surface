...
declare module "tar"
{
    ...
    export interface ICreateOptions
    {
        ...
        /** Set to true to omit writing mtime values for entries. Note that this prevents using other mtime-based features like tar.update or the keepNewer option with the resulting tar archive. [Alias: m, no-mtime] */
        noMtime?: unknown;
    ...
    export interface IExtractOptions
    {
        ...
        /** Allow absolute paths, paths containing .., and extracting through symbolic links. By default, / is stripped from absolute paths, .. paths are not extracted, and any file whose location would be modified by a symbolic link is not extracted. [Alias: P] */
        preservePaths?: unknown;
        /** Treat warnings as crash-worthy errors. Default false. */
        strict?: unknown;
        /** Remove the specified number of leading path elements. Pathnames with fewer elements will be silently skipped. Note that the pathname is edited after applying the filter, but before security checks. [Alias: strip-components, stripComponents] */
        strip?: unknown;
        ...
        umask?: unknown;
        /** Unlink files before creating them. Without this option, tar overwrites existing files, which preserves existing hardlinks. With this option, existing hardlinks will be broken, as will any symlink that would affect the location of an extracted file. [Alias: U] */
        unlink?: unknown;
     ...
     */
    export function create(options: ICreateOptions, fileList: Array<string>): Promise<Stream>;
    export function create(options: ICreateOptions, fileList: Array<string>, callback: (promise: Promise<unknown>) => void): void;
     ...
     * @param callback Callback
     */
    export function extract(options: IExtractOptions, fileList: Array<string>): Promise<Stream>;
    export function extract(options: IExtractOptions, fileList: Array<string>, callback: (promise: Promise<unknown>) => void): void;
     ...
     * @param callback
     */
    export function list(options: IListOptions, fileList: Array<string>): Promise<Stream>;
    export function list(options: IListOptions, fileList: Array<string>, callback: (promise: Promise<unknown>) => void): void;
     ...
     * @param callback
     */
    export function replace(options: IReplaceOptions, fileList: Array<string>): Promise<Stream>;
    export function replace(options: IReplaceOptions, fileList: Array<string>, callback: (promise: Promise<unknown>) => void): void;
     ...
     * @param callback
     */
    export function update(options: IUpdateOptions, fileList: Array<string>): Promise<Stream>;
    export function update(options: IUpdateOptions, fileList: Array<string>, callback: (promise: Promise<unknown>) => void): void;
