...
[
    ...
    },
    {
        ...
        source:     "**",
        regex:      /^(?:[\/\\]?[^.\/\\][^\/\\]*)*[\/\\]?$/,
        matches:    ["foo", "foo.txt", "foo/", "foo/bar", "foo/bar.txt", "foo/bar/", "foo/bar/baz", "foo/bar/baz/"],
        mismatches: [],
    },
    {
        skip:       false,
        ...
        mismatches: ["foo", "foo.txt", "/foo/.bar.txt"],
    },
    {
        skip,
        source:     "**/*",
        ...
        mismatches: ["foo/", "foo/bar/"],
    },
    {
        skip,
        source:     "**/*.txt",
        regex:      /^(?:[\/\\]?[^.\/\\][^\/\\]*)*[\/\\]?[^.\/\\][^\/\\]*\.txt$/,
        matches:    ["foo.txt", "foo/bar.txt", "foo/bar/baz.txt"],
    ...
    },
    {
        ...
        source:     "**/*.{txt,csv}",
        regex:      /^(?:[\/\\]?[^.\/\\][^\/\\]*)*[\/\\]?[^.\/\\][^\/\\]*\.(?:txt|csv)$/,
        matches:    ["foo.txt", "foo.csv", "foo/bar.txt", "foo/bar.csv"],
        mismatches: ["foo", "foo.zip", "foo/bar", "foo/bar.zip"],
    },
    {
        skip,
        source:     "[?*/**@(@(a|b))]",
