...
import ChoiceDirective                    from "../directives/choice-directive-legacy.js";
import EventDirective                     from "../directives/event-directive-legacy.js";
import InjectDirective                    from "../directives/inject-directive-legacy.js";
import LoopDirective                      from "../directives/loop-directive-legacy.js";
import PlaceholderDirective               from "../directives/placeholder-directive-legacy.js";
...
import type { DirectiveFactory }          from "../types/directive-entry-legacy";
import type EventDirectiveDescriptor      from "../types/event-directive-descriptor-legacy";
import type TemplateDirectiveContext      from "../types/template-directive-context-legacy";
import type TemplateDirectivesDescriptor  from "../types/template-directives-descriptor-legacy";
import type TemplateProcessorContext      from "../types/template-processor-context-legacy";
